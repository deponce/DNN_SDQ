...
g++ -shared -fPIC -std=c++11 -I./pybind11/include/ -I/usr/include/python3.10 HDQ_OptD_SWE_module.cpp -o HDQ_OptD_SWE.so
# g++ -shared -fPIC -std=c++11 -I./pybind11/include/ -I/usr/include/python3.8 DeepN_JPEG_module.cpp -o DeepN_JPEG.so
# python3 test.py
